...
public class Opdr4_4_redo extends Applet {
  ...
  public void paint(Graphics g) {
	  ...
	  g.fillRect(125, 115, 20, Valerie);// grafiek balk valerie
	  g.fillRect(120, 160, 10, 10);
	  g.setColor(Color.magenta);
	  g.fillRect(145, 10, 20, Jeroen);// grafiek balk jeroen
	  g.fillRect(120, 175, 10, 10);
	  g.setColor(Color.blue);
	  g.fillRect(165, 50, 20, Hans);// grafiek balk hans
